...
namespace Nekhbet\LaravelGettext\Config;

use \Nekhbet\LaravelGettext\Config\Models\Config as ConfigModel;
use \Nekhbet\LaravelGettext\Exceptions\RequiredConfigurationFileException;
use \Nekhbet\LaravelGettext\Exceptions\RequiredConfigurationKeyException;
...
class ConfigManager
{
    ...
    protected function generateFromArray(array $config)
    {
        ...
        $adapter = isset($config['adapter']) ? $config['adapter'] : \Nekhbet\LaravelGettext\Adapters\LaravelAdapter::class;
