...
namespace Nekhbet\LaravelGettext\Translators;

use Nekhbet\LaravelGettext\FileSystem;
use Nekhbet\LaravelGettext\Adapters\AdapterInterface;
use Nekhbet\LaravelGettext\Config\Models\Config;
use Nekhbet\LaravelGettext\Exceptions\LocaleNotSupportedException;
use Nekhbet\LaravelGettext\Exceptions\MissingPhpGettextModuleException;
use Nekhbet\LaravelGettext\Exceptions\UndefinedDomainException;

use Illuminate\Support\Facades\Session;
use Nekhbet\LaravelGettext\Storages\Storage;

/**
 * Class implemented by the php-gettext module translator
 * @package Nekhbet\LaravelGettext\Translators
 */
class Gettext extends BaseTranslator implements TranslatorInterface
{
    /**
     * Config container
     * @type \Nekhbet\LaravelGettext\Config\Models\Config
     */
    ...
    /**
     * Framework adapter
     * @type \Nekhbet\LaravelGettext\Adapters\LaravelAdapter
     */
    protected $adapter;
